...
function useFetchUsers( /* username */) {
    ...
    var _c = react_1.default.useState(), isLoading = _c[0], setIsLoading = _c[1];
    react_1.default.useEffect(function () {
        function fetchUser() {
            return __awaiter(this, void 0, void 0, function () {
                var response, userResponse, err_1;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            setError();
                            setIsLoading(true);
                            return [4 /*yield*/, fetch("/api/test-endpoint")];
                        case 1:
                            response = _a.sent();
...
function MainContent() {
    var _a = useFetchUsers(), users = _a.users, isLoading = _a.isLoading, error = _a.error;
    console.log({
        users: users,
        isLoading: isLoading,
        error: error
